...
class TacticalBlueprintData {
  static const List<FormationInfo> formations = [
    ...
    FormationInfo(
      id: '4-5-1',
      name: '4-5-1',
      description: 'Compact midfield five, disciplined wide players, lone striker',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',    abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rb',  positionName: 'Right Back',    abbreviation: 'RB',  x: 0.82, y: 0.75),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',      abbreviation: 'RCB', x: 0.63, y: 0.78),
        BlueprintPosition(positionId: 'lcb', positionName: 'Left CB',       abbreviation: 'LCB', x: 0.37, y: 0.78),
        BlueprintPosition(positionId: 'lb',  positionName: 'Left Back',     abbreviation: 'LB',  x: 0.18, y: 0.75),
        BlueprintPosition(positionId: 'rm',  positionName: 'Right MF',      abbreviation: 'RM',  x: 0.88, y: 0.52),
        BlueprintPosition(positionId: 'rcm', positionName: 'Right CM',      abbreviation: 'RCM', x: 0.66, y: 0.52),
        BlueprintPosition(positionId: 'cm',  positionName: 'Central CM',    abbreviation: 'CM',  x: 0.50, y: 0.50),
        BlueprintPosition(positionId: 'lcm', positionName: 'Left CM',       abbreviation: 'LCM', x: 0.34, y: 0.52),
        BlueprintPosition(positionId: 'lm',  positionName: 'Left MF',       abbreviation: 'LM',  x: 0.12, y: 0.52),
        BlueprintPosition(positionId: 'st',  positionName: 'Striker',       abbreviation: 'ST',  x: 0.50, y: 0.18),
      ],
    ),
    FormationInfo(
      id: '4-3-2-1',
      name: '4-3-2-1',
      description: 'Christmas tree — three CMs, two attacking mids, lone striker',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',    abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rb',  positionName: 'Right Back',    abbreviation: 'RB',  x: 0.82, y: 0.75),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',      abbreviation: 'RCB', x: 0.63, y: 0.78),
        BlueprintPosition(positionId: 'lcb', positionName: 'Left CB',       abbreviation: 'LCB', x: 0.37, y: 0.78),
        BlueprintPosition(positionId: 'lb',  positionName: 'Left Back',     abbreviation: 'LB',  x: 0.18, y: 0.75),
        BlueprintPosition(positionId: 'rcm', positionName: 'Right CM',      abbreviation: 'RCM', x: 0.68, y: 0.58),
        BlueprintPosition(positionId: 'cm',  positionName: 'Central CM',    abbreviation: 'CM',  x: 0.50, y: 0.56),
        BlueprintPosition(positionId: 'lcm', positionName: 'Left CM',       abbreviation: 'LCM', x: 0.32, y: 0.58),
        BlueprintPosition(positionId: 'ram', positionName: 'Right AM',      abbreviation: 'RAM', x: 0.65, y: 0.36),
        BlueprintPosition(positionId: 'lam', positionName: 'Left AM',       abbreviation: 'LAM', x: 0.35, y: 0.36),
        BlueprintPosition(positionId: 'st',  positionName: 'Striker',       abbreviation: 'ST',  x: 0.50, y: 0.16),
      ],
    ),
    FormationInfo(
      id: '4-1-4-1',
      name: '4-1-4-1',
      description: 'Single pivot anchor, wide midfield four, lone striker',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',    abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rb',  positionName: 'Right Back',    abbreviation: 'RB',  x: 0.82, y: 0.75),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',      abbreviation: 'RCB', x: 0.63, y: 0.78),
        BlueprintPosition(positionId: 'lcb', positionName: 'Left CB',       abbreviation: 'LCB', x: 0.37, y: 0.78),
        BlueprintPosition(positionId: 'lb',  positionName: 'Left Back',     abbreviation: 'LB',  x: 0.18, y: 0.75),
        BlueprintPosition(positionId: 'dm',  positionName: 'Defensive MF',  abbreviation: 'DM',  x: 0.50, y: 0.64),
        BlueprintPosition(positionId: 'rm',  positionName: 'Right MF',      abbreviation: 'RM',  x: 0.85, y: 0.46),
        BlueprintPosition(positionId: 'rcm', positionName: 'Right CM',      abbreviation: 'RCM', x: 0.62, y: 0.46),
        BlueprintPosition(positionId: 'lcm', positionName: 'Left CM',       abbreviation: 'LCM', x: 0.38, y: 0.46),
        BlueprintPosition(positionId: 'lm',  positionName: 'Left MF',       abbreviation: 'LM',  x: 0.15, y: 0.46),
        BlueprintPosition(positionId: 'st',  positionName: 'Striker',       abbreviation: 'ST',  x: 0.50, y: 0.18),
      ],
    ),
    FormationInfo(
      id: '5-3-2',
      name: '5-3-2',
      description: 'Five-back solidity, three CMs, two-striker punch',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',      abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rwb', positionName: 'Right Wing Back', abbreviation: 'RWB', x: 0.88, y: 0.62),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',        abbreviation: 'RCB', x: 0.70, y: 0.76),
        BlueprintPosition(positionId: 'cb',  positionName: 'Center CB',       abbreviation: 'CB',  x: 0.50, y: 0.80),
        BlueprintPosition(positionId: 'lcb', positionName: 'Left CB',         abbreviation: 'LCB', x: 0.30, y: 0.76),
        BlueprintPosition(positionId: 'lwb', positionName: 'Left Wing Back',  abbreviation: 'LWB', x: 0.12, y: 0.62),
        BlueprintPosition(positionId: 'rcm', positionName: 'Right CM',        abbreviation: 'RCM', x: 0.66, y: 0.48),
        BlueprintPosition(positionId: 'cm',  positionName: 'Central CM',      abbreviation: 'CM',  x: 0.50, y: 0.46),
        BlueprintPosition(positionId: 'lcm', positionName: 'Left CM',         abbreviation: 'LCM', x: 0.34, y: 0.48),
        BlueprintPosition(positionId: 'rst', positionName: 'Right Striker',   abbreviation: 'RS',  x: 0.63, y: 0.20),
        BlueprintPosition(positionId: 'lst', positionName: 'Left Striker',    abbreviation: 'LS',  x: 0.37, y: 0.20),
      ],
    ),
    FormationInfo(
      id: '3-1-3-3',
      name: '3-1-3-3',
      description: 'Three CBs, holding mid, three CMs, three-front attack',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',    abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',      abbreviation: 'RCB', x: 0.72, y: 0.76),
        BlueprintPosition(positionId: 'cb',  positionName: 'Center CB',     abbreviation: 'CB',  x: 0.50, y: 0.80),
        BlueprintPosition(positionId: 'lcb', positionName: 'Left CB',       abbreviation: 'LCB', x: 0.28, y: 0.76),
        BlueprintPosition(positionId: 'dm',  positionName: 'Defensive MF',  abbreviation: 'DM',  x: 0.50, y: 0.64),
        BlueprintPosition(positionId: 'rm',  positionName: 'Right MF',      abbreviation: 'RM',  x: 0.78, y: 0.50),
        BlueprintPosition(positionId: 'cm',  positionName: 'Central CM',    abbreviation: 'CM',  x: 0.50, y: 0.50),
        BlueprintPosition(positionId: 'lm',  positionName: 'Left MF',       abbreviation: 'LM',  x: 0.22, y: 0.50),
        BlueprintPosition(positionId: 'rw',  positionName: 'Right Winger',  abbreviation: 'RW',  x: 0.80, y: 0.24),
        BlueprintPosition(positionId: 'st',  positionName: 'Striker',       abbreviation: 'ST',  x: 0.50, y: 0.18),
        BlueprintPosition(positionId: 'lw',  positionName: 'Left Winger',   abbreviation: 'LW',  x: 0.20, y: 0.24),
      ],
    ),
    FormationInfo(
      id: '4-1-2-3',
      name: '4-1-2-3',
      description: 'Holding mid base, two box-to-box CMs, wide three-front',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',    abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rb',  positionName: 'Right Back',    abbreviation: 'RB',  x: 0.82, y: 0.75),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',      abbreviation: 'RCB', x: 0.63, y: 0.78),
        BlueprintPosition(positionId: 'lcb', positionName: 'Left CB',       abbreviation: 'LCB', x: 0.37, y: 0.78),
        BlueprintPosition(positionId: 'lb',  positionName: 'Left Back',     abbreviation: 'LB',  x: 0.18, y: 0.75),
        BlueprintPosition(positionId: 'dm',  positionName: 'Defensive MF',  abbreviation: 'DM',  x: 0.50, y: 0.62),
        BlueprintPosition(positionId: 'rcm', positionName: 'Right CM',      abbreviation: 'RCM', x: 0.65, y: 0.46),
        BlueprintPosition(positionId: 'lcm', positionName: 'Left CM',       abbreviation: 'LCM', x: 0.35, y: 0.46),
        BlueprintPosition(positionId: 'rw',  positionName: 'Right Winger',  abbreviation: 'RW',  x: 0.82, y: 0.24),
        BlueprintPosition(positionId: 'st',  positionName: 'Striker',       abbreviation: 'ST',  x: 0.50, y: 0.18),
        BlueprintPosition(positionId: 'lw',  positionName: 'Left Winger',   abbreviation: 'LW',  x: 0.18, y: 0.24),
      ],
    ),
    FormationInfo(
      id: '4-2-2-2',
      name: '4-2-2-2',
      description: 'Double pivot base, two attacking mids behind two strikers',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',    abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rb',  positionName: 'Right Back',    abbreviation: 'RB',  x: 0.82, y: 0.75),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',      abbreviation: 'RCB', x: 0.63, y: 0.78),
        ...
        BlueprintPosition(positionId: 'rdm', positionName: 'Right DM',      abbreviation: 'RDM', x: 0.63, y: 0.60),
        BlueprintPosition(positionId: 'ldm', positionName: 'Left DM',       abbreviation: 'LDM', x: 0.37, y: 0.60),
        BlueprintPosition(positionId: 'ram', positionName: 'Right AM',      abbreviation: 'RAM', x: 0.65, y: 0.40),
        BlueprintPosition(positionId: 'lam', positionName: 'Left AM',       abbreviation: 'LAM', x: 0.35, y: 0.40),
        BlueprintPosition(positionId: 'rst', positionName: 'Right Striker', abbreviation: 'RS',  x: 0.63, y: 0.20),
        BlueprintPosition(positionId: 'lst', positionName: 'Left Striker',  abbreviation: 'LS',  x: 0.37, y: 0.20),
      ],
    ),
    FormationInfo(
      id: '4-3-1-2',
      name: '4-3-1-2',
      description: 'Three CMs, #10 playmaker, two-striker partnership',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',    abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rb',  positionName: 'Right Back',    abbreviation: 'RB',  x: 0.82, y: 0.75),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',      abbreviation: 'RCB', x: 0.63, y: 0.78),
        ...
        BlueprintPosition(positionId: 'cm',  positionName: 'Central CM',    abbreviation: 'CM',  x: 0.50, y: 0.56),
        BlueprintPosition(positionId: 'lcm', positionName: 'Left CM',       abbreviation: 'LCM', x: 0.32, y: 0.58),
        BlueprintPosition(positionId: 'cam', positionName: 'Attacking MF',  abbreviation: 'CAM', x: 0.50, y: 0.40),
        BlueprintPosition(positionId: 'rst', positionName: 'Right Striker', abbreviation: 'RS',  x: 0.63, y: 0.20),
        BlueprintPosition(positionId: 'lst', positionName: 'Left Striker',  abbreviation: 'LS',  x: 0.37, y: 0.20),
      ],
    ),
    FormationInfo(
      id: '5-2-1-2',
      name: '5-2-1-2',
      description: 'Five-back shield, double pivot, #10 link, two strikers',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',      abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rwb', positionName: 'Right Wing Back', abbreviation: 'RWB', x: 0.88, y: 0.64),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',        abbreviation: 'RCB', x: 0.70, y: 0.76),
        BlueprintPosition(positionId: 'cb',  positionName: 'Center CB',       abbreviation: 'CB',  x: 0.50, y: 0.80),
        BlueprintPosition(positionId: 'lcb', positionName: 'Left CB',         abbreviation: 'LCB', x: 0.30, y: 0.76),
        BlueprintPosition(positionId: 'lwb', positionName: 'Left Wing Back',  abbreviation: 'LWB', x: 0.12, y: 0.64),
        BlueprintPosition(positionId: 'rdm', positionName: 'Right DM',        abbreviation: 'RDM', x: 0.63, y: 0.54),
        BlueprintPosition(positionId: 'ldm', positionName: 'Left DM',         abbreviation: 'LDM', x: 0.37, y: 0.54),
        BlueprintPosition(positionId: 'cam', positionName: 'Attacking MF',    abbreviation: 'CAM', x: 0.50, y: 0.38),
        BlueprintPosition(positionId: 'rst', positionName: 'Right Striker',   abbreviation: 'RS',  x: 0.63, y: 0.20),
        BlueprintPosition(positionId: 'lst', positionName: 'Left Striker',    abbreviation: 'LS',  x: 0.37, y: 0.20),
      ],
    ),
    FormationInfo(
      id: '5-2-3',
      name: '5-2-3',
      description: 'Five-back width, two-CM engine, three-front attack',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',      abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rwb', positionName: 'Right Wing Back', abbreviation: 'RWB', x: 0.88, y: 0.62),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',        abbreviation: 'RCB', x: 0.70, y: 0.76),
        ...
        BlueprintPosition(positionId: 'lcb', positionName: 'Left CB',         abbreviation: 'LCB', x: 0.30, y: 0.76),
        BlueprintPosition(positionId: 'lwb', positionName: 'Left Wing Back',  abbreviation: 'LWB', x: 0.12, y: 0.62),
        BlueprintPosition(positionId: 'rcm', positionName: 'Right CM',        abbreviation: 'RCM', x: 0.65, y: 0.48),
        BlueprintPosition(positionId: 'lcm', positionName: 'Left CM',         abbreviation: 'LCM', x: 0.35, y: 0.48),
        BlueprintPosition(positionId: 'rw',  positionName: 'Right Winger',    abbreviation: 'RW',  x: 0.80, y: 0.22),
        BlueprintPosition(positionId: 'st',  positionName: 'Striker',         abbreviation: 'ST',  x: 0.50, y: 0.18),
        BlueprintPosition(positionId: 'lw',  positionName: 'Left Winger',     abbreviation: 'LW',  x: 0.20, y: 0.22),
      ],
    ),
    FormationInfo(
      id: '5-2-2-1',
      name: '5-2-2-1',
      description: 'Five-back security, double pivot, two AMs, lone striker',
      positions: [
        BlueprintPosition(positionId: 'gk',  positionName: 'Goalkeeper',      abbreviation: 'GK',  x: 0.50, y: 0.92),
        BlueprintPosition(positionId: 'rwb', positionName: 'Right Wing Back', abbreviation: 'RWB', x: 0.88, y: 0.64),
        BlueprintPosition(positionId: 'rcb', positionName: 'Right CB',        abbreviation: 'RCB', x: 0.70, y: 0.76),
        ...
        BlueprintPosition(positionId: 'rdm', positionName: 'Right DM',        abbreviation: 'RDM', x: 0.63, y: 0.54),
        BlueprintPosition(positionId: 'ldm', positionName: 'Left DM',         abbreviation: 'LDM', x: 0.37, y: 0.54),
        BlueprintPosition(positionId: 'ram', positionName: 'Right AM',        abbreviation: 'RAM', x: 0.65, y: 0.38),
        BlueprintPosition(positionId: 'lam', positionName: 'Left AM',         abbreviation: 'LAM', x: 0.35, y: 0.38),
        BlueprintPosition(positionId: 'st',  positionName: 'Striker',         abbreviation: 'ST',  x: 0.50, y: 0.18),
      ],
    ),
  ];
